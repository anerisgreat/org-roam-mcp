...
class OrgRoamFileManager:
    ...
    def create_node(self, title: str, content: str = "", tags: List[str] = None) -> str:
    ...
    def update_node_content(self, node: OrgRoamNode, new_content: str):
    ...
    def _update_file_content(self, file_path: str, new_content: str):
    ...
    def add_link_to_node(self, source_file: str, target_node_id: str, target_title: str, position: Optional[int] = None):
