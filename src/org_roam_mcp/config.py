...
class OrgRoamConfig:
    ...
    def from_environment(cls) -> "OrgRoamConfig":
        ...
        return cls(db_path=db_path, org_roam_directory=org_roam_dir, max_search_results=max_results)
    ...
    def validate(self) -> None:
        ...
        if not os.access(self.org_roam_directory, os.W_OK):
            raise PermissionError(
                f"No write access to org-roam directory: {self.org_roam_directory}"
            )
